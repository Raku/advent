...
3. Use [Hilite::Simple](https://raku.land/zef:librasteve/Hilite::Simple) to highlight any raku or rakudoc code in your article by pasting the results into a Wordpress Custom HTML block (use Preview to check it).
