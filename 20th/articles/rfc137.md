...
However, recently I found an interesting definition of what magic is: _kind action  a person performs to achieve a result which doesn't logically follow from the action itself_.
